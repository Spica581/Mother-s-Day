...
const REASONS = [
  {
    emoji: '🤗',
    title: 'Ang mga yakap niyo',
    body:  'Kahit gaano kahirap ang mga araw ko, isang yakap lang mula sainyo feel ko na ligtas na ako',
    color: 'from-rose-100 to-pink-50',
    glow:  'rgba(255,107,157,0.25)',
  },
  {
    emoji: '🍳',
    title: 'Mga pagluluto niyong may love',
    body:  'Bawat pagkaing niluto mo ay may timplang pagmamahal at pag-aalaga. Nalalasahan ko ang pagmamahal sa bawat kagat.',
    color: 'from-orange-50 to-amber-50',
    glow:  'rgba(244,195,161,0.35)',
  },
  {
    emoji: '🌙',
    title: 'Di niyo ako sinukuan',
    body:  'Kahit gumagawa ako ng mga mistakes, Naniwala ka sa akin nung di ko kaya',
    color: 'from-purple-50 to-pink-50',
    glow:  'rgba(196,160,219,0.3)',
  },
  {
    emoji: '📚',
    title: 'Ikaw ang nagturo sa akin ng lahat',
    body:  'Mula sa pagtatali ng aking sapatos hanggang sa pagharap sa mundo — bawat aral na alam ko, natutunan ko sa panonood sa iyo.',
    color: 'from-blue-50 to-indigo-50',
    glow:  'rgba(129,161,216,0.3)',
  },
  {
    emoji: '😊',
    title: 'Ang iyong ngiti ay maliwanag',
    body:  'Tuwing naririnig ko yung mga tawa niyo, lumiliwanag ang mundo ko',
    color: 'from-yellow-50 to-orange-50',
    glow:  'rgba(253,224,71,0.3)',
  },
  {
    emoji: '🛡️',
    title: 'Lagi mo ako pinoprotektahan',
    body:  'Ikaw ang humawak sa pagitan ko at ng bawat takot, bawat mapang-api, bawat madilim na gabi. Ang aking anghel na tagapagbantay.',
    color: 'from-green-50 to-teal-50',
    glow:  'rgba(52,211,153,0.25)',
  },
  {
    emoji: '💪',
    title: 'Ikaw ang aking huwaran',
    body:  'Ang iyong lakas, biyaya, at katatagan ang nagpakita sa akin kung ano ang ibig sabihin ng pagiging isang tunay na bayani.',
  ...
  },
  {
    ...
    body:  'Nasaan ka man, ikaw ang aking tahanan. Ginawa mong santuwaryo ng pag-ibig ang apat na pader.',
